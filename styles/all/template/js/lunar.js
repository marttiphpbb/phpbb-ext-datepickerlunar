...
$.datepicker._updateDatepicker = function(inst) {
	...
	var moon = '<span class="fa-stack marttiphpbb-datepickerlunar" data-day="15"><i class="fa fa-circle fa-inverse fa-stack-1x"></i><i class="fa fa-circle-o fa-stack-1x"></i></span>';
	$td.each(function(){
		var $this = $(this);
		var day = $this.text();
		if (day == '15'){

			$this.find('a').html(moon);
		}
	});
